  ...
  return (
    <div className="bg-white rounded-xl shadow-md relative">
      <div className="p-4">
        ...
        <button className="text-indigo-500 mb-5 hover:text-indigo-600" onClick={() => setCollapseDescription((currentState) => !currentState)}>
          Show {collapseDescription ? 'More' : 'Less'}
        </button>
